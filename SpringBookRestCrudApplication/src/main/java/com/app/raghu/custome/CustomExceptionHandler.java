...
public class CustomExceptionHandler {
	 ...
	 * ResponseEntity<String> showStudentNotFound( StudentNotFoundException snfe ) {
	 * 
	 * return new ResponseEntity<String>( snfe.getMessage(),
	...
	public ResponseEntity<ErrorMessage> showStudentNotFound(StudentNotFoundException snfe) {
		...
		return new ResponseEntity<ErrorMessage>(
				new ErrorMessage(snfe.getMessage(), "STUDENT", "NOT FOUND", new Date().toString()),
				HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
